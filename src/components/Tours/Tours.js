...
const Tours = () => {
  ...
  return (
    <div className='container' id='tours'>
      <h3 className='wow animate__animated animate__fadeInLeft title'>
        Explore our Tours
      </h3>
            ...
            <div className='card-footer'>
              <div className='card-footer-details'>
                ...
                <p>
                  ...
                  <span className='text'>rating (6)</span>
                </p>
              </div>
          ...
          <div className='card'>
            <div className='card-header'>
              <div className='card-picture'>
                ...
                <img
                  className='img'
                  src={require('./img/the-mountain-biker.jpg')}
                  alt='the-mountain-biker'
                />
              </div>
              <h3>
                <span>The Mountain Biker</span>
              </h3>
            </div>
        ...
        <div className='col-sm-10  col-md-6 col-lg-4'>
          <div className='card'>
            ...
            <div className='card-footer'>
              <div className='card-footer-details'>
                <p>
                  <span className='value'>$1497</span>{' '}
                  <span className='text'>per person</span>
                </p>
                <p>
                  <span className='value'>4.9</span>{' '}
                  <span className='text'>rating (5)</span>
                </p>
              </div>
          ...
          <div className='card'>
            ...
            <div className='card-footer'>
              <div className='card-footer-details'>
                ...
                <p>
                  <span className='value'>4.9</span>{' '}
                  <span className='text'>rating (7)</span>
                </p>
              </div>
        ...
        <div className='col-sm-10  col-md-6 col-lg-4'>
          <div className='card'>
            ...
            <div className='card-footer'>
              <div className='card-footer-details'>
                <p>
                  <span className='value'>$2497</span>{' '}
                  <span className='text'>per person</span>
                </p>
                <p>
                  <span className='value'>4.9</span>{' '}
          ...
          <div className='card'>
            <div className='card-header'>
              <div className='card-picture'>
                ...
                <img
                  className='img'
                  src={require('./img/tour-8.jpg')}
                  alt='tour-8'
                />
              </div>
              <h3>
                <span>The Star Gazer</span>
              </h3>
            </div>
            ...
            <div className='card-body'>
              ...
              <p>
                The most remote and stunningly beautiful places for seeing the
                night sky
              </p>
            ...
            <div className='card-footer'>
              <div className='card-footer-details'>
                <p>
                  <span className='value'>$697</span>{' '}
                  <span className='text'>per person</span>
                </p>
                <p>
                  <span className='value'>4.5</span>{' '}
                  <span className='text'>rating (8)</span>
                </p>
              </div>
        ...
        <div className='col-sm-10  col-md-6 col-lg-4'>
          <div className='card'>
            ...
            <div className='card-body'>
              ...
              <p>
                Exquisite wines, scenic views, exclusive barrel tastings, and
                much more
              </p>
            ...
            <div className='card-footer'>
              <div className='card-footer-details'>
                <p>
                  <span className='value'>$1897</span>{' '}
                  <span className='text'>per person</span>
                </p>
                <p>
                  <span className='value'>4.9</span>{' '}
        ...
        <div className='col-sm-10  col-md-6 col-lg-4'>
          <div className='card'>
            ...
            <div className='card-footer'>
              <div className='card-footer-details'>
                <p>
                  <span className='value'>$1297</span>{' '}
                  <span className='text'>per person</span>
                </p>
                <p>
