  ...
  features: [
    {
      ...
      geometry: {
        type: 'Point',
        coordinates: [-114.57156, 47.965655],
      },
      properties: {
    ...
    <div className='container-fluid' id='mountain-biker'>
      <div className='row'>
        ...
        <div className='col-md-12'>
          ...
          <div className='picture-box'>
            <img
              src={require('./../../img/tour-5cdb06c8d87ca1051d90eda9-1557860998703-1.jpeg')}
              alt='tour-2-2'
            />
          </div>
          <div className='picture-box'>
            <img
              src={require('./../../img/tour-5cdb06c8d87ca1051d90eda9-1557860998703-3.jpeg')}
              alt='tour-2-3'
            />
          </div>
        </div>
          ...
          <div className='cont'>
            ...
            <div className='content'>
              <div>
                ...
                <p>
                  4 days. 1 adventure. Infinite memories. Make it yours today!
                </p>
              </div>
            </div>
          </div>
