...
const geojson = {
    ...
    features: [
        ...
        },
        {
            ...
            geometry: {
                type: 'Point',
                coordinates: [-107.4380650, 39.284315]
            },
            properties: {
...
class ForestHiker extends React.Component {
    state = {
        viewport: {}
    }
                    ...
                    <div className="row">
                        <div className="col-md-12 ">
                            <div className="header">
                                ...
                                <img src={require('./../../img/tour-1.jpg')} alt="the-forest-hiker" />
                            </div>
                            <div className="box">
                                <h1>
                            ...
                            <div className="cont">
                                ...
                                <div className="content">
                                    <div>
                                        ...
                                        <p>14 days. 1 adventure. Infinite memories. Make it yours today!</p>
                                    </div>
                                </div>
                            </div>
