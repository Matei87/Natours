...
const geojson = {
    ...
    features: [
        ...
        },
        {
            ...
            geometry: {
                type: 'Point',
                coordinates: [-80.05054030, 40.4314779]
            },
            properties: {
...
class CityWonderer extends React.Component {
    state = {
        viewport: {}
    }
                    ...
                    <div className="row">
                        <div className="col-md-12 ">
                            <div className="header">
                                ...
                                <img src={require('./../../img/tour-4.jpg')} alt="the-city-wonderer" />
                            </div>
                            <div className="box">
                                <h1>
                        ...
                        <div className="col-md-12">
                            <div className="overview-box">
                                <div>
                                    ...
                                    <div className="overview-box-group">
                                        ...
                                        <div className="overview-box-group-detail">
                                            <img src={require('./../../img/user-12.jpg')} alt="Lead.Guide" />
                            ...
                            <div className="description-box">
                                ...
                                <p className="description-text">
                                    ...
                                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur, nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat!
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="container">
                                ...
                                <Slider {...settings}>
                                    ...
                                    <div className="col-md-4">
                                        <div className="card">
                                            <div className="card-header">
                                                <img src={require('./../../img/user-2.jpg')} alt="Lourdes Browning" />
                            ...
                            <div className="cont">
                                ...
                                <div className="content">
                                    <div>
                                        ...
                                        <p>5 days. 1 adventure. Infinite memories. Make it yours today!</p>
                                    </div>
                                </div>
                            </div>
