...
class SnowAdventurer extends React.Component {
    state = {
        viewport: {}
    }
                    ...
                    <div className="row">
                        <div className="col-md-12 ">
                            <div className="header">
                                ...
                                <img src={require('./../../img/nat-7.jpg')} alt="the-snow-adventurer" />
                            </div>
                            <div className="box">
                                <h1>
                        ...
                        <div className="col-md-12">
                            <div className="overview-box">
                                <div>
                                    ...
                                    <div className="overview-box-group">
                                        ...
                                        <div className="overview-box-group-detail">
                                            <img src={require('./../../img/user-13.jpg')} alt="Tour.Guide" />
                            ...
                            <div className="description-box">
                                ...
                                <p className="description-text">
                                    ...
                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. cupidatat non proident,
                            ...
                            <div className="cont">
                                ...
                                <div className="content">
                                    <div>
                                        ...
                                        <p>3 days. 1 adventure. Infinite memories. Make it yours today!</p>
                                    </div>
                                </div>
                            </div>
